...
public class CodeGenerator {
    ...
    public void setNeedMockFields(List<PsiField> needMockFields) {
        this.needMockFields = needMockFields;
    }

    public List<MyMethod> getNeedMockMethods() {
        return needMockMethods;
    }

    public void setNeedMockMethods(List<MyMethod> needMockMethods) {
    ...
    public void setNeedImports(Set<String> needImports) {
        this.needImports = needImports;
    }
    ...
    public void setMethodCount(Map<String, Integer> methodCount) {
